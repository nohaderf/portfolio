            ...
            <div className="content-div">
                ...
                <div>
                    <p>I'm a full stack developer, based in Toronto, who left medicine to pursue a creative path in software development.
                        ...
                        than my previous role in medicine. </p>
                        <p>I am well versed in JavaScript, ReactJS, HTML, CSS, postgreSQL, Python and Ruby on Rails. 
                            I possess strong skills in Adobe Photoshop and have experience with converting images to HTML/CSS layouts. Additionally, I am adept in component performance optimization, scalable software design, designing and translating wireframes, and building reusable cross platform components.</p>
                        <span>
